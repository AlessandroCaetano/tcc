...
A norma \cite{artAndScience}, que regulamenta toda a formatação a ser usada na 
...
\cite{soWhat}, disponível na internet.
...
entre parênteses como (Anexo I). Para referências\cite{pageRank} a mais de um anexo as mesmas 
