...
\todo[inline, backgroundcolor=yellow!20!white, bordercolor=red]{Aqui continua mencionando e discorrendo sobre o método experimental de estudo de caso. Esse método que será utilizado para validar sua solução entrará no tcc2. Por agora atenha-se a idéia de um exemplo de uso para explorar a viabilidade de sua solução.}
