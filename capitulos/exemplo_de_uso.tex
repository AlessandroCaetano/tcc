...
\todo[inline, backgroundcolor=yellow!20!white, bordercolor=red]{Conforme conversamos utilize algumas daquelas figuras que estão na documentação do SPB. Não se esqueça de citar além de explicar figura}
...
\todo[inline, backgroundcolor=yellow!20!white, bordercolor=red]{Pense naquela reestruturação que conversamos sobre o Scrum e XP irem como um subtopico do planemento de release no cap. (de forma bem resumida) 3 O importante nesse caso é apresentar as carcterísticas e dificuldades do planejamento de release e como o scrum e o xp trabalham com o planejamento de release. Assim, aqui você não precisa retormar as definições desses métodos e fica focado em explicar como o SPB foi organizado.}
...
na Wiki do projeto. \todo{Lembre-se de arrumar a figura depois que você ler o plano de trabalho do SPB}
